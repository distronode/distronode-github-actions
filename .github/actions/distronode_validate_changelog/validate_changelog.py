...
def is_changelog_needed(changes: dict[str, list[str]]) -> bool:
    ...
    # https://docs.distronode.com/distronode/latest/reference_appendices/release_and_maintenance.html#generating-changelogs
...
def is_valid_changelog_format(path: str) -> bool:
    ...
    try:
        ...
        # https://github.com/distronode-community/antsibull-changelog/blob/main/docs/changelogs.rst#changelog-fragment-categories
        changes_type = (
            "release_summary",
            "breaking_changes",
            "major_changes",
